...
def calculate_matrix_product(X, W):
    ...
    """
    res = torch.matmul(X,torch.t(W))  # TODO: implement this function 
    return res
...
def calculate_matrix_prod_with_bias(X, W, b):
    ...
    Hint: use torch.matmul to calculate the product.
          ...
          Also, it allows us to use the same function for a single neuron or multiple neurons.
       """
    res = torch.matmul(X,torch.t(W)) + b  # TODO: implement this function 
    return res
...
def calculate_activation(sum_total):
    ...
    res = torch.heaviside(sum_total, values=values) # TODO: implement this function 
    return res
...
def calculate_output(X, W, b):
    ...
    res = calculate_activation(total)  # TODO: implement this function 
    return res